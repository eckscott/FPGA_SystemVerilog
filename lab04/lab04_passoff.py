...
def main():
    ...
    tester.add_required_tracked_files(["FullAdd.sv", "Add8.sv", "arithmetic_top.sv",
            "sim_FullAdd.tcl", "sim_Add8.tcl", "hierarchy.png", "post-schematic.png"])
    tester.add_Makefile_rule("sim_testbench", [], ["testbench.log"])
    tester.add_build_test(repo_test.file_regex_check("testbench.log", "Error:", "Testbench Log Test"))
